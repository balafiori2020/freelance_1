class ZCL_ZFCL_SHIVA_TEST_MPC definition
  public
...
public section.
  ...
  types:
     TS_SALEORDER type ZFL_SO_ST .
  types:
TT_SALEORDER type standard table of TS_SALEORDER .
  types:
  ...
  types:
TT_DEBIA type standard table of TS_DEBIA .
  types:
     TS_ITEM type ZFL_ITEM_ST .
  types:
TT_ITEM type standard table of TS_ITEM .

  constants GC_DEBIA type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Debia' ##NO_TEXT.
  constants GC_ITEM type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Item' ##NO_TEXT.
  constants GC_SALEORDER type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Saleorder' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZFCL_SHIVA_TEST_MPC=======CP' ##NO_TEXT.

  methods DEFINE_SALEORDER
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_DEBIA
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_ITEM
    raising
...
CLASS ZCL_ZFCL_SHIVA_TEST_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZFCL_SHIVA_TEST_SRV' ).
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            iv_association_name = 'AssoItem' "#EC NOTEXT
                            iv_left_type        = 'Saleorder' "#EC NOTEXT
...
* Navigation Properties for entity - Saleorder
lo_entity_type = model->get_entity_type( iv_entity_name = 'Saleorder' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'NavItem' "#EC NOTEXT
                                                              iv_abap_fieldname = 'NAVITEM' "#EC NOTEXT
                                                              iv_association_name = 'AssoItem' ). "#EC NOTEXT
lo_nav_property->set_label_from_text_element( iv_text_element_symbol = '008' iv_text_element_container = gc_incl_name ). "#EC NOTEXT
  endmethod.
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Debia' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZFCL_SHIVA_TEST_MPC=>TS_DEBIA' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'DebiaSet' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZFL_ITEM_ST'
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Saleorder' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZFL_SO_ST'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'SaleorderSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20210406094833'.                  "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'NavItem'.                    "#EC NOTEXT
ls_text_element-artifact_type          = 'NAVP'.                                         "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Saleorder'.                              "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'Debia'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'AssoItem'.                               "#EC NOTEXT
